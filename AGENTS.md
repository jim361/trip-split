...
- 고정 작업 ID는 `TASK-01`부터 `TASK-09`까지이며, 숫자 suffix가 같은 `MarkDown/task/task_function1_*.md`부터 `task_function9_*.md`까지에 1:1 대응합니다. 기존 작업 ID와 파일명을 재번호·재사용·변경·삭제하지 않습니다.
